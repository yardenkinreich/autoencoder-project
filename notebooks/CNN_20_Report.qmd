...
This report summarizes the run of the CNN 20 Latent Variable pipeline, including training results, reconstructions, and clustering.
...
![](../results/clustering_cnn_20_dots.png){width=100%}


## Plot Clustering of PCA on Latent Variables: Julie D. Stopar Craters Images

![](../results/clustering_cnn_20_imgs.png){width=100%}

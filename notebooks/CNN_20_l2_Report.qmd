---
title: "Convolutional Neural Network Lunar Crater Identification - 20 Latent Variables & L2 Regulation"
...
This report summarizes the run of the CNN 20 Latent Variable with L2 Regulation pipeline, including training results, reconstructions, and clustering.
...
%cd /home/yardenk/autoencoder_project
...
print(f"Used {train_val_split} portion for validation")
print(f"Training epochs: {epochs}")
print(f"Batch size: {batch_size}")
print("Used L2 regulation, in ADAM optimizer")
...
![](../models/loss_curve_20_l2.png){width=100%}


## Model Reconstruction Figure

![](../models/reconstructions_cnn_20_l2.png){width=100%}


## Plot Clustering of PCA on Latent Variables: Julie D. Stopar Craters with Labels

![](../results/clustering_cnn_20_l2_dots.png){width=100%}


## Plot Clustering of PCA on Latent Variables: Julie D. Stopar Craters Images

![](../results/clustering_cnn_20_l2_imgs.png){width=100%}
...
This report summarizes the run of the cae 6 Latent Variable pipeline, including training results, reconstructions, and clustering.
...
![](../results/clustering_cae_6_dots.png){width=100%}


## Plot Clustering of PCA on Latent Variables: Julie D. Stopar Craters Images

![](../results/clustering_cae_6_imgs.png){width=100%}

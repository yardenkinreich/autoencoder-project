...
from src.models.dinov2.dinov2.eval.cell_dino.knn import get_args_parser as get_knn_args_parser
...
class Evaluator:
    ...
    def __call__(self):
        from src.models.dinov2.dinov2.eval.cell_dino.knn import main as knn_main

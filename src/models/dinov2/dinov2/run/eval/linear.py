...
from src.models.dinov2.dinov2.eval.linear import get_args_parser as get_linear_args_parser
...
class Evaluator:
    ...
    def __call__(self):
        from src.models.dinov2.dinov2.eval.linear import main as linear_main

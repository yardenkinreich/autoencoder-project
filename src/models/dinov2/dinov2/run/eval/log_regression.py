...
from src.models.dinov2.dinov2.eval.log_regression import get_args_parser as get_log_regression_args_parser
from src.models.dinov2.dinov2.logging import setup_logging
from src.models.dinov2.dinov2.run.submit import get_args_parser, submit_jobs
...
class Evaluator:
    ...
    def __call__(self):
        from src.models.dinov2.dinov2.eval.log_regression import main as log_regression_main
